...
import './Registrationonly.css';

const Registrationonly = ({ isOpen, onClose }) => {
    const [loading, setLoading] = useState(false);
    const [statusMsg, setStatusMsg] = useState("");
    const [authorCount, setAuthorCount] = useState("1"); // Dynamic author count

    const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxRxaaJJqPNKWFuL7NyM8pumDrb04m2k6CEurjVlUcDXXlDZB7YyDMxOLlcR-DCydng/exec";
...
{/* Co-Author 3 */}
    ...
    <div className="full-width">
        <button type="submit" disabled={loading} className="modal-submit-button">
            {loading ? "Uploading Documents..." : " Register"}
        </button>
        {statusMsg && (
...
export default Registrationonly;